...
//     app.get("/users/all/:email", verifyToken, verifyAdmin,  async (req, res) => {
...
//    app.get("/scholarships", verifyToken, verifyAdmin, async (req, res) => {
//   const {
//     search = "",
//     subject = "",
//     category = "",
...
//   // Dynamic sorting: 1 for Ascending (ace), -1 for Descending (dce)
//   const sortOptions = {};
...
// });
//     app.get("/scholarships/:email/manage", verifyToken, verifyAdmin, async (req, res) => {
//       const {email} = req.params
...
//       res.send(result)
//     })
//     app.get("/scholarships/:id/details", verifyToken, verifyAdmin, async (req, res) => {
//       const {id} = req.params
//       const query = {_id: new ObjectId(id)}
...
//       res.send(result)
//     })
//     app.patch("/scholarships/:id/update/scholarship", verifyToken, verifyAdmin, async (req, res) => {
//       const {id} = req.params;
...
//     app.get("/applications/manage", verifyToken, isMod, async (req, res) => {
...
//       res.send(result)
//     })
//     app.get("/applications/:email/applied", verifyToken, isStudent, async (req, res) => {
//       const {email} = req.params
...
//       res.send(result)
//     })
//     app.get("/applications/:id/details", verifyToken, isStudent, async (req, res) => {
//       const {id} = req.params
//       const query = {_id: new ObjectId(id)}
//       const result = await applicationCollection.findOne(query)
//       res.send(result)
//     })
//     app.patch("/applications/:id/status", verifyToken, isStudent, async (req, res) => {
//       const {id} = req.params
...
//     })
//     app.post("/applications", verifyToken, isStudent,  async (req, res) => {
//       const newApplication = req.body;
//       const result = await applicationCollection.insertOne(newApplication)
//       res.send(result)
//     })
//     app.patch("/applications/:id/feedback", verifyToken, isMod, async (req, res) => {
//       const {id} = req.params
...
//     })
//     app.patch("/applications/:id/update/application", verifyToken, isStudent, async (req, res) => {
//       const {id} = req.params;
...
//       res.send(result)
//     })
//     app.delete("/applications/:id", verifyToken, isStudent, async (req, res) => {
//       const {id} = req.params;
//       const query = {_id: new ObjectId(id)}
...
//    app.get("/reviews", verifyToken, isMod, async (req, res) => {
//     const result = await reviewCollection.find().toArray()
//     res.send(result)
//    })
//    app.get("/reviews/user/:email",verifyToken, isStudent, async (req, res) => {
//      const {email} = req.params
//       const query = {userEmail: email}
//       const result = await reviewCollection.find(query).toArray()
//       res.send(result)
//    })
//    app.post("/reviews", verifyToken, isStudent, async (req, res) => {
//     const newReview = req.body
//     const result = await reviewCollection.insertOne(newReview)
//     res.send(result)
//    })
//    app.patch("/reviews/:id/update/review", verifyToken, isStudent, async (req, res) => {
//     const {id} = req.params;
...
//    app.delete("/reviews/:id", verifyToken, isStudent, async (req, res) => {
//     const {id} = req.params;
//       const query = {_id: new ObjectId(id)}
...
// });
//     app.put('payments/session-status',verifyToken,  async (req, res) => {
...
//   // admin status
//   app.get("/stats/charts-revenu", verifyToken, verifyAdmin, async (req, res) => {
